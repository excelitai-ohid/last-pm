...
let lists = document.querySelectorAll('.dashb-kanban-content-single');
...
// pie chart start single project
let myDoughnutChart = document.getElementById("doughnut");
...
let chart1 = new Chart(myDoughnutChart, {
    ...
    data: {
        ...
        datasets: [{
            data: [50, 31, 19],
            backgroundColor: ['#FA8D31', '#009CDC', '#008135']
        }]
    },
